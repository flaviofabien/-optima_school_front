...
export default function LenuLinkButtonPlus({data,dataInclude,setrDataInclude}: Props) {
    ...
    <div>
        ...
        <div className="w-full bg-white p-4">
            ...
            {
                data?.matiere.filter( (i : any) =>  {
                    console.log( Teacher.idMatiere,"matiere",i.id);
                    
                    if (user.role === "Enseignant" && Teacher) {
                        return (i.idNiveau == dataInclude.niveau.id &&  i.id == Teacher?.idMatiere ) 
                     } else    return i.idNiveau == dataInclude.niveau.id 
