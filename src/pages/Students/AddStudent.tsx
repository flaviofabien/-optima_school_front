...
import { studentSchema } from "../../Zod-Validation/Students"
...
export default function AddStudent() {
    ...
    const mutation = useMutation(
        {
        mutationFn: (newUser : any) => CreateStudents(token,newUser),
        onSuccess: async () => {
            setErrorServer("");
    ...
    <div className="">
        <div className=" w-full flex justify-center  items-center">
            <div className="w-full h-[700px] flex justify-center items-center" >
                <form className="h-full w-[800px] flex justify-center items-center bg-white relative  2xl:rounded-s-3xl rounded-3xl" onSubmit={handleSubmit(onSubmit)} >
                ...
                <img src={ImgFontLogo} className="2xl:block hidden w-1/3 h-full  object-cover  rounded-e-3xl" alt="" />
            </div>
        </div>
    </div>
  )
