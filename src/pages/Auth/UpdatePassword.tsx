...
export default function UpdatePassword() {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-[var(--font)]" >
      <div className="flex w-[1500px] h-[800px] bg-[var(--white)] items-center rounded-2xl lg:rounded-s-3xl relative">
        <form className="p-2 md:p-8  lg:p-16 justify-center flex w-full items-center" onSubmit={handleSubmit(onSubmit)} >
          <div className="w-full mt-8 min-w-[320px]">
              <img src={ImgLogo} className="rrelative lg:absolute lg:left-16 lg:top-16 left-0 top-0  w-40 mb-12 lg:mb-8 object-cover rounded-r-4xl" alt="" />
        ...
        <img src={ImgFont} className=" w-full lg:max-w-[500px] xl:max-w-[800px] h-full object-cover rounded-r-4xl hidden  lg:block rounded-e-3xl" alt="" />
      </div>
    </div>
