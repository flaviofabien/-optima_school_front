...
import { MatiereEditSchema } from "../../Zod-Validation/Matiere"
...
export default function EditMatiere({}: Props) {
    ...
    const {data : dataMatiere,isLoading : userOneIsLoading ,isError : userOneIsError} = useQuery<any>({
    ...
    const mutation = useMutation(
        {
        mutationFn: (newUser : any) => UpdateMatieres(token,newUser,id!),
        onSuccess: () => {
            setErrorServer("");
            ...
            <div className="w-full h-[700px] flex justify-center items-center" >
                <form className="w-[600px] h-full bg-white flex justify-center items-center relative rounded-2xl" onSubmit={handleSubmit(onSubmit)} >
                    <div className="w-full  rounded-2xl pt-20 px-8">
                        <TitleForm title="Modifier matiere" />
