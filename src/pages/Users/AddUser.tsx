...
export default function AddUser() {
  ...
  return (
    <div className="">
        <div className="mt-4 w-full flex justify-center px-1 lg:px-8  items-center">
            <div className="w-full h-[800px]  flex  items-center" >
                <form className=" h-full w-full 2xl:w-[500px] bg-white p-8 relative rounded-3xl lg:rounded-s-3xl" onSubmit={handleSubmit(onSubmit)} >
