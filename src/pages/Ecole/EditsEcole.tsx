    ...
    <div className="">
        <div className="mt-4 w-full flex justify-center items-center">
            <div className="w-full  h-[700px]  mt-8 flex justify-center items-center" >
                <form className=" h-full w-[500px] bg-white relative 2xl:rounded-s-3xl rounded-3xl" onSubmit={handleSubmit(onSubmit)} >
                    ...
                    {errorServer  && <Validation errorServer={errorServer} /> }
                        ...
                        <div className="flex sm:flex-row flex-col gap-2 sm:gap-8 mt-8 justify-between items-start mb-8">
                            <Button text="Modification" type="submit" load={load}  />
                            <ButtonLink text="Retour" link="/admin/ecoles" style={1}  />
                        </div>
                    </div>
                </form>
                <img src={ImgFontLogo} className="hidden 2xl:block w-[1000px] h-full  object-cover  rounded-e-3xl" alt="" />
            </div>
        </div>
    </div>
  )
